# Generated by Django 4.2.26 on 2025-12-12 02:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='restaurant_images/', verbose_name='店舗画像')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='作成日時')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crud.category', verbose_name='カテゴリ')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
